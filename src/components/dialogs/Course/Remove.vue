<template>
    ...
    :cancel_save="cancel_save" :info="info" >
        
       <div>
           <p>¿Desea eliminar el curso <strong><i>{{titleCourse}}</i></strong>?</p>
       </div>
...
<script>
import Base from '../BaseModal.vue'
...
export default {
    ...
    methods: {
        save(){
            ...
            CourseService.remove(idCourse).then(
                (response) => {
